...
<body>
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      ...
      <hr>
      <ul class="list-group">
        <li class="list-group-item"><img src="image/<?= $dsn['foto_dosen']; ?>" width="200px" alt=""></li>
        <li class="list-group-item">Nama : <?= $dsn['nama']; ?></li>
        <li class="list-group-item">NIDN : <?= $dsn['nidn']; ?></li>
        <li class="list-group-item">Jenis kelamin : <?= $dsn['jenis_kelamin']; ?></li>
        <li class="list-group-item">Alamat rumah : <?= $dsn['alamat_rumah']; ?></li>
        <li class="list-group-item">Agama : <?= $dsn['agama']; ?></li>
        <li class="list-group-item">Pendidikan S1 : <?= $dsn['pendidikan_s1']; ?></li>
        <li class="list-group-item">Pendidikan S2 : <?= $dsn['pendidikan_s2']; ?></li>
        <li class="list-group-item">Pendidikan S3 : <?= $dsn['pendidikan_s3']; ?></li>
        <li class="list-group-item">
          <a href="hapusdsn.php?id=<?= $dsn['nidn']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?');" class="btn btn-danger" role="button">Hapus</a> |
